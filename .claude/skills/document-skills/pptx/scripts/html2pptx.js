  ...
  return await page.evaluate(() => {
      ...
      element.childNodes.forEach((node) => {
        ...
        if (isText) {
          ...
          if (
            ...
            const isBold =
              computed.fontWeight === "bold" || Number.parseInt(computed.fontWeight) >= 600;
    ...
    document.querySelectorAll("*").forEach((el) => {
      ...
      if (textTags.includes(el.tagName)) {
        ...
        const hasBorder =
          (computed.borderWidth && Number.parseFloat(computed.borderWidth) > 0) ||
          (computed.borderTopWidth && Number.parseFloat(computed.borderTopWidth) > 0) ||
          (computed.borderRightWidth && Number.parseFloat(computed.borderRightWidth) > 0) ||
          (computed.borderBottomWidth && Number.parseFloat(computed.borderBottomWidth) > 0) ||
          (computed.borderLeftWidth && Number.parseFloat(computed.borderLeftWidth) > 0);
